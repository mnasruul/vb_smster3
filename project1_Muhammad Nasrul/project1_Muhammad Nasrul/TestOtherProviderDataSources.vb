...
Public Class TestOtherProviderDataSources
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "TestOtherProviderDataSources.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "project1_Muhammad_Nasrul.TestOtherProviderDataSources.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedTestOtherProviderDataSources
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As TestOtherProviderDataSources = New TestOtherProviderDataSources()
        rpt.Site = Me.Site
        Return rpt
    End Function
