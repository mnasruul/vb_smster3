...
Public Class koneksi
    ...
    Public Function openconn() As Boolean
        koneksi = New OleDbConnection("provider=Microsoft.ACE.OLEDB.12.0;data source=D:\KULIAH\SEMESTER 3\VB\PERTEMUAN\penjualan_Muhammad Nasrul.accdb;Persist Security Info=False")
